...
from tests.streamlit_agent.callbacks.capturing_callback_handler import playback_callbacks
from tests.streamlit_agent.clear_results import with_clear_container
...
# Initialize agent
prompt_text=UnstructuredMarkdownLoader()
